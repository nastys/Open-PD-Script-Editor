...
public:
    static int getOpcodeNumber(QString opcodeString)
    {
        ...
        else if(opcodeString=="RESERVE1") return 0x54;
        else if(opcodeString=="RESERVE2") return 0x55;
        else if(opcodeString=="RESERVE3") return 0x56;
        else if(opcodeString=="RESERVE4") return 0x57;
        else if(opcodeString=="PV_AUTH_LIGHT_PRIORITY") return 0x58;
        else if(opcodeString=="PV_CHARA_LIGHT") return 0x59;
        else if(opcodeString=="PV_STAGE_LIGHT") return 0x5A;
        else if(opcodeString=="TARGET_EFFECT") return 0x5B;
        ...
        else if(opcodeString=="CROSSFADE") return 0x67;
        else if(opcodeString=="SUBFRAMERENDER") return 0x68;
        else if(opcodeString=="EVENT_JUDGE") return 0x69;
        else if(opcodeString=="TOON＿EDGE") return 0x6A;
        else if(opcodeString=="FOG_ENABLE") return 0x6B;
        else if(opcodeString=="EDIT_CAMERA_BOX") return 0x6C;
        else if(opcodeString=="EDIT_STAGE_PARAM") return 0x6D;
        else if(opcodeString=="EDIT_CHANGE_FIELD") return 0x6E;
        else return -1;
    }
    static QString getOpcodeString(int opcodeNumber)
    {
        switch(opcodeNumber)
        {
            ...
            case 0x52: return "EDIT_MODE_SELECT";
            case 0x53: return "PV_END_FADEOUT";
            case 0x54: return "RESERVE1";
            case 0x55: return "RESERVE2";
            case 0x56: return "RESERVE3";
            case 0x57: return "RESERVE4";
            case 0x58: return "PV_AUTH_LIGHT_PRIORITY";
            case 0x59: return "PV_CHARA_LIGHT";
            case 0x5A: return "PV_STAGE_LIGHT";
            case 0x5B: return "TARGET_EFFECT";
            ...
            case 0x65: return "ITEM_ALPHA";
            case 0x66: return "MOVIE_CUT";
            case 0x67: return "CROSSFADE";
            case 0x68: return "SUBFRAMERENDERER";
            case 0x69: return "EVENT_JUDGE";
            case 0x6A: return "TOON＿EDGE";
            case 0x6B: return "FOG_ENABLE";
            case 0x6C: return "EDIT_CAMERA_BOX";
            case 0x6D: return "EDIT_STAGE_PARAM";
            case 0x6E: return "EDIT_CHANGE_FIELD";
            default:
            QString opcode="UNKNOWN_OPCODE_0x"+QString::number(opcodeNumber, 16);
            QMessageBox::warning(nullptr, "Warning", opcode);
            return opcode;
